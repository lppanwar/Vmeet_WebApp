     ...
     <div>
       {
        doctors.slice(0,3).map((items,index)=>(
          <div className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:ghap-6 py-2 border-b " key={index}>
         <div>
         ...
         <div className="flex-1 text-sm text-zinc-600">
          ...
          <p className="text-xs mt-1"><span className="text-sm text-shadow-neutral-700 font-medium">Date & Time</span> 25, july, 2024 | 8:30 PM</p>
         </div>
         <div></div>
